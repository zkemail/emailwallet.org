...
const InfoGraphLg = () => {
  ...
  return (
    <div className="mt-16 hidden items-center gap-x-4 lg:flex">
      ...
      <div className="mb-14 flex flex-col-reverse items-center gap-2 drop-shadow">
        <div className="flex items-center text-[#7B9BF3]">
          ----------------------
          <ArrowRight className="-ml-[2px] mt-[1px]" size={17} />
        </div>
